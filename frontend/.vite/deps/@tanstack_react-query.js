...
function hydrate(client, dehydratedState, options) {
    ...
    queries.forEach(
        ({ queryKey, state, queryHash, meta, promise, dehydratedAt }) => {
            ...
            const data =
                rawData === void 0 ? rawData : deserializeData(rawData);
            ...
            if (
                ...
                query
                    .fetch(void 0, {
                        ...
                        initialPromise:
                            Promise.resolve(promise).then(deserializeData),
                    })
                    .catch(noop);
            }
        },
...
var InfiniteQueryObserver = class extends QueryObserver {
    ...
    createResult(query, options) {
        ...
        const { isFetching, isRefetching, isError, isRefetchError } =
            parentResult;
        ...
        const isFetchingPreviousPage =
            isFetching && fetchDirection === "backward";
        const result = {
            ...parentResult,
...
var MutationObserver = class extends Subscribable {
    ...
    setOptions(options) {
        ...
        if (
            ...
            hashKey(prevOptions.mutationKey) !==
                hashKey(this.options.mutationKey)
        ) {
            this.reset();
...
var QueriesObserver = class extends Subscribable {
    ...
    setQueries(queries, options) {
        ...
        notifyManager.batch(() => {
            ...
            const newObserverMatches = this.#findMatchingObservers(
                this.#queries,
            );
            ...
            const newObservers = newObserverMatches.map(
                (match) => match.observer,
            );
    ...
    #notify() {
        if (this.hasListeners()) {
            ...
            const newTracked = this.#trackResult(
                this.#result,
