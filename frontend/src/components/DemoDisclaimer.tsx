...
export function DemoDisclaimer() {
  return (
    ...
    >
      ...
      <p>
        The public application uses a shortened demonstration configuration. Results reported in the
        study were generated through controlled offline experiments.
      </p>
    </div>
  )
}
